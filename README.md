...
- **No full-vault scan per query** — inverted indexes narrow candidates before scoring. Mobile is [being verified for the v0.6.6 prerelease](docs/mobile-testing.md)
...
|---|---|---|
| Max results | 20 | |
| Limit to the same root folder | off | Keeps candidates under the active note's top-level folder |
