...
- **No full-vault scan per query** — inverted indexes narrow candidates before scoring. Mobile is [being verified for the v0.6.1 prerelease](docs/mobile-testing.md)
